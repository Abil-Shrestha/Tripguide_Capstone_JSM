...
const Passengers = () => {
  ...
  const adultIncrement = () => setAdults();
  const adultDecrement = () => setAdults();
  const childIncrement = () => setChildrenPassenger();
  const childDecrement = () => setChildrenPassenger();
  const infantIncrement = () => setInfants();
  const infantDecrement = () => setInfants();
